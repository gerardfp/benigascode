package com.benigascode.common.config;

import com.benigascode.identity.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .csrf(csrf -> csrf
                ...
                .ignoringRequestMatchers("/api/v1/auth/**", "/api/v1/runner/**", "/actuator/**", "/api/v1/webhooks/**")
            )
